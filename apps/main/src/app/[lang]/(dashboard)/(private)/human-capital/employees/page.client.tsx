      ...
      <Stack spacing={4}>
        <Box>
          ...
          <Typography variant='body2' color='text.secondary'>
            Administración de empleados y acciones de seguridad.
          </Typography>
        </Box>
        ...
        <Card>
          <CardContent>
            <Stack spacing={4}>
              <Box>
                <Typography variant='h6'>Restablecer MFA de usuario</Typography>
                <Typography variant='body2' color='text.secondary'>
                  Usa esta acción cuando un usuario perdió acceso a Google Authenticator. El MFA anterior se
                  desactivará y el usuario deberá enrolar un nuevo código QR en su próximo inicio de sesión.
                </Typography>
              </Box>
