 ...
 */
export function collectChanges(originals: Record<string, number>, edited: Record<string, number>): ViewChange[] {
...
export function hasPendingChanges(originals: Record<string, number>, edited: Record<string, number>): boolean {
