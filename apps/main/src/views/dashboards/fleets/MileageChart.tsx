...
const MileageChart = ({ t, data }: Props) => {
  ...
  const options: ApexOptions = {
    ...
    yaxis: {
      ...
      labels: {
        ...
        formatter: value => `${value > 999 ? `${(value / 1000).toFixed(0)}k` : value} km`
      }
    }
  }
  ...
  return (
    <AppReactApexCharts
      ...
      height={220}
      width='100%'
      series={[{ name: t('dashboard.fleets.mileage'), data: kms }]}
      options={options}
    />
  )
}
