    ...
    <Box className='flex flex-col gap-4'>
          ...
          <Box position='relative'>
            ...
            >
              {branding.logoUrl ? (
                ...
                <svg width='60px' height='60px' viewBox='0 0 32 32' fill='var(--mui-palette-text-secondary)'>
      ...
      <Box>
        ...
        <Box display='flex' gap={2} alignItems='flex-start' flexWrap='wrap'>
          <Box sx={{ '& .react-colorful': { width: 200, height: 160 } }}>
            <HexColorPicker color={branding.primaryColor ?? '#0f172a'} onChange={handleColorPickerChange} />
          </Box>
      ...
      <Box>
        ...
        <Box display='flex' gap={2} flexWrap='wrap'>
          ...
          >
            <Typography
              sx={{ fontFamily: '"Plus Jakarta Sans", sans-serif', fontSize: '1.1rem', fontWeight: 600, mb: 0.5 }}
            >
              Plus Jakarta Sans
            </Typography>
            <Typography
              sx={{ fontFamily: '"Plus Jakarta Sans", sans-serif', fontSize: '0.75rem', color: 'text.secondary' }}
            >
              Aa Bb Cc 0-9
            </Typography>
          </Box>
