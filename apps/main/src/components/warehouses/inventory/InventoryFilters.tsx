    ...
    <Grid container spacing={3} alignItems='center'>
      ...
      <Grid size={{ xs: 12, sm: 6, lg: 2 }}>
        <FormControl fullWidth>
          <InputLabel id='inventory-warehouse-filter-label'>Almacén</InputLabel>
      ...
      <Grid size={{ xs: 12, sm: 6, lg: 2 }}>
        <FormControl fullWidth>
          <InputLabel id='inventory-status-filter-label'>Estado</InputLabel>
      ...
      <Grid size={{ xs: 12, sm: 6, lg: 2 }}>
        <FormControl fullWidth>
          <InputLabel id='inventory-category-filter-label'>Categoría</InputLabel>
      ...
      <Grid size={{ xs: 12, sm: 6, lg: 2 }}>
        <FormControl fullWidth>
          <InputLabel id='inventory-active-filter-label'>SKU</InputLabel>

          <Select
            labelId='inventory-active-filter-label'
            label='SKU'
            value={active}
            onChange={event => onActiveChange(event.target.value as InventoryActiveFilter)}
          >
      ...
      <Grid size={{ xs: 12 }}>
        <Grid container spacing={2} justifyContent='flex-end'>
          <Grid>
            <Button variant='outlined' startIcon={<i className='ri-filter-off-line' />} onClick={onReset}>
              Limpiar filtros
            </Button>
          </Grid>
