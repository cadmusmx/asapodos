                        ...
                        <TableRow>
                            <TableCell colSpan={9}>
                                <Stack alignItems='center' spacing={1} sx={{ py: 7 }}>
                                    ...
                                    <Typography variant='body2' color='text.secondary'>
                                        Ajusta los filtros o registra existencias mediante
                            ...
                            return (
                                <TableRow key={row.inventoryStockId} hover>
                                    ...
                                    <TableCell align='right'>
                                        {formatInventoryQuantity(row.stock.onHand)}
                                    </TableCell>

                                    <TableCell align='right'>
                                        {formatInventoryQuantity(row.stock.reserved)}
                                    </TableCell>

                                    <TableCell align='right'>
                                        <Typography fontWeight={700}>
                                            {formatInventoryQuantity(row.stock.available)}
                                        </Typography>
                                    </TableCell>

                                    <TableCell sx={{ whiteSpace: 'nowrap' }}>
                                        <Typography variant='body2'>
                                            {formatInventoryDateTime(row.stock.updatedAt)}
                                        </Typography>
