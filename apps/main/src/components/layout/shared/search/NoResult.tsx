  ...
  return (
    <div className='flex items-center justify-center grow flex-wrap plb-14 pli-16 overflow-y-auto overflow-x-hidden bs-full'>
      <div className='flex flex-col items-center'>
        ...
        <p className='text-lg font-medium leading-[1.55556] mbe-11'>{t('search.noResult', { query: searchValue })}</p>
        <p className='text-[15px] leading-[1.4667] mbe-4 text-textDisabled'>{t('search.trySearching')}</p>
