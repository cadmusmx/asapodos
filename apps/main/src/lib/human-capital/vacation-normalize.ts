...
export const normalizeVacationBalanceFromRow = (
    row: HumanCapitalVacationBalanceRow
): HumanCapitalVacationBalance => {
    ...
    const availableDays = row.AvailableDays === undefined || row.AvailableDays === null
...
export const normalizeVacationRequestFromRow = (
    row: HumanCapitalVacationRequestRow
): HumanCapitalVacationRequest => ({
