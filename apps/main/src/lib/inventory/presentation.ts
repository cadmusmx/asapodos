export type InventoryStatusColor = 'default' | 'primary' | 'secondary' | 'error' | 'info' | 'success' | 'warning'
...
export const getInventoryStatusColor = (value: string): InventoryStatusColor => {
