...
interface EvidenciaImg { dataUrl: string | null; url: string | null; tipo: string }
interface EvidenciaDoc { tipo: string; url: string }
...
export interface LogisticaViewModel {
  folio: string; tipoTxt: string; fechaTxt: string;
  xdock: string; carrierTxt: string; responsable: string; correo: string;
  unidadPlaca: string; nombreOperador: string; fechaCreacionTxt: string; fechaEdicionTxt: string;
  llegadaTxt: string; inicioDescargaTxt: string; salidaTxt: string; estadiaTxt: string; descargaTxt: string;
  sitios: SitioVM[];
}
